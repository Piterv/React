...
mongoose.connect('mongodb+srv://admin-peter:Test123@cluster0.kulrb.mongodb.net/keeper').
...
app.post("/update", function (req, res) {
    ...
    Note.findByIdAndUpdate({ _id: note.noteId }, { title: note.title, content: note.content }, (err, foundNote) => {
        if (!err) {
            res.json({ message: "File is successfully updated" });
        }
    });
